...
指针数组是一个存放指针的数组,可以理解成一个[[Arrays#二维数组创建和初始化|二维数组]]
...
此时`pi`**（对指针解引用）等价于“数组名”。**[[Pointer Exercises#^1af50c|习题]]
...
数组传参的三种表示方式：[[Arrays#^0339bd|数组传参的方式]]
...
**二维数组的形式参数，可以省略行，但是不能省略列**[[Arrays#^d117cf|二维数组的创建]]

#### 总结

- **C 语言的数组传参**：只传“首地址”，不传“形状”。[[Arrays#^ddd149|数组传参时“退化”]]
